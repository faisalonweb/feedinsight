...
//  FeedInsight
//
//  Created by Hamza Iqbal on 07/10/2020.
...
class GaugeView: UIView {
    ...
    var innerBezelColor = UIColor(red: 169, green: 169, blue: 169, alpha: 1)
    var innerBezelWidth: CGFloat = 1

    var insideColor = UIColor.white
    
    var segmentWidth: CGFloat = 5
    var segmentColors = [UIColor(red: 1, green: 1, blue: 1, alpha: 1), UIColor(red: 0, green: 0.5, blue: 0, alpha: 1), UIColor(red: 0, green: 0.5, blue: 0, alpha: 1), UIColor(red: 0.7, green: 0, blue: 0, alpha: 1)]
    ...
    var majorTickLength: CGFloat = 8

    var minorTickColor = UIColor.black.withAlphaComponent(0.5)
    var minorTickWidth: CGFloat = 0
    var minorTickLength: CGFloat = 0
    var minorTickCount = 3
    
    var outerCenterDiscColor = UIColor(white: 0.9, alpha: 1)
    var outerCenterDiscWidth: CGFloat = 0
    var innerCenterDiscColor = UIColor(red: 0, green: 0.5, blue: 0, alpha: 1)
    var innerCenterDiscWidth: CGFloat = 15
    
    var needleColor = UIColor(red: 0, green: 0.5, blue: 0, alpha: 1)
