...
extension ResultsViewController: UITableViewDelegate , UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath.row == 0) {
            ...
            cell?.moisture.text = String(Mositure[indexPath.row])
            cell?.CP.text = String(CP[indexPath.row])
            cell?.Fat.text = String(Fat[indexPath.row])
            cell?.Ash.text = String(Ash[indexPath.row])
            cell?.CF.text = String(CF[indexPath.row])
            cell?.ADF.text = String(ADF[indexPath.row])
            cell?.NDF.text = String(NDF[indexPath.row])
            cell?.Search.text = String(Starch[indexPath.row])
            cell?.layer.cornerRadius = 10
